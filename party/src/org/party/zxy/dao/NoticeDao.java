...
import org.party.zxy.dao.provider.NoticeDynaSqlProvider;
import org.party.zxy.domain.Notice;

import static org.party.zxy.util.common.HrmConstants.NOTICETABLE;
	...
	// 动态查询
		...
		@Results({
			...
			@Result(column="TYPE_ID",property="type",
				one=@One(select="org.party.zxy.dao.TypeDao.selectById",
			fetchType=FetchType.EAGER)),
			@Result(column="USER_ID",property="user",
				one=@One(select="org.party.zxy.dao.UserDao.selectById",
			fetchType=FetchType.EAGER))
		})
